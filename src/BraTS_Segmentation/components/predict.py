...
my_model = load_model('./artifacts/models/brats_3d_v3.hdf5', 
                      compile=False)
...
############# Plot 55 slices from test predictions for verification
...
plt.savefig('./artifacts/plots/predictions_on_test_368.png')
plt.show()
