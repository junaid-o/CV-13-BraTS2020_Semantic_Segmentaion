...
from src.BraTS_Segmentation.components.custom_datagen import DataGenerator
...
from src.BraTS_Segmentation.components.simple_3d_unet import UNET_model
...
model = UNET_model.simple_unet_model(IMG_HEIGHT=128, 
                          IMG_WIDTH=128, 
                          IMG_DEPTH=128, 
                          IMG_CHANNELS=3, 
                          num_classes=4)
...
plt.savefig('./artifacts/plots/training_loss.png')
...
my_model = load_model('./artifacts/models/brats_3d.hdf5', 
                      custom_objects={'dice_loss_plus_1focal_loss': total_loss,
...
os.makedirs("./artifacts/plots", exist_ok=True)
plt.savefig('./artifacts/plots/predictions_on_test.png')
plt.show()
