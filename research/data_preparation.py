...
#####################   COMINING 3 CHANNELS OF EACH IMAGE AS NUMPY  ###############################
#
...
test_mask = test_mask[56:184, 56:184, 13:141] #Crop to 128x128x128x4

#################### VISUALIZATION AFTER CROP
...
########### SAVING PROCESSED IMAGES IN NUMPY FORMAT

os.makedirs("../BraTS2020_DataSet/BraTS2020_numpy/train", exist_ok=True)
...
my_img=np.load('BraTS2020_DataSet/BraTS2020_numpy/train/combined255.npy')
